%This Matlab script can be used to generate Figure 3 (a) and (b) in the lecture note:
...
% power allocation is borrowed from the Matlab package of the followingbook:
